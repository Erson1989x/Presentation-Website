      ...
      <div className="px-4 rounded flex items-center justify-between h-16 w-full relative z-50 bg-gray-800">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button 
            ...
            className="px-2 py-1 text-sm rounded text-gray-900 hover:text-black transition-colors border border-gray-600"
          >
            {lang.toUpperCase()}
          </button>
        </div>
        ...
        <div className="hidden md:flex md:items-center md:space-x-8">
          ...
          <a href="#contact" className="px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition-colors">
            {t.contact}
          </a>
        </div>
