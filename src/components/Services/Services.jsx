...
import mobix from "../../assets/Projects/carrent.png"
    ...
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white border-2 border-gray-200 rounded-lg shadow-md p-4">
            ...
            <h3 className="text-xl text-gray-800 font-semibold mt-4">Ecommerce</h3>
            <p className="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet</p>
